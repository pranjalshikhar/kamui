        ...
        <div className="flex flex-col my-2">
          ...
          >
            ...
            <div className="flex items-center mt-2 max-w-md">
              ...
              <button
                type="submit"
                className="inline-flex justify-evenly items-center w-20 px-2 py-3 rounded-sm btn btn-primary btn-lg  sm:mb-0 mr-2 transition-colors duration-200 transform bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-80 text-white uppercase font-semibold"
              >
                Add
              </button>
            </div>
